...
@section('content')
    ...
    <div class="container col-md-8 col-md-offset-2">
        <div class="well well bs-component">
            <div class="content">
                  <h2 class="header">{!! $ticket->title !!}</h2>
                      <p> <strong>Status</strong>: {!! $ticket->status ? 'Pending' : 'Closed' !!}</p>
        ...
        <div class="well well bs-component">
            <form class="form-horizontal" method="post" action="/public_html_1/comment">
                ...
                <!-- This is a hidden input field to allow for the submitting of     ticket id (post_id) -->
                <!-- -->
